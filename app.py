...
LATEST_UPDATE = "Hey guys, working on making the site faster. -An33sh"
...
# --- CACHED GAME LOADING (INSTANT LOAD) ---
@st.cache_data
...
def launch_game(file_path):
    # This part was slow because it reads the file every click. Now it's direct.
